...
function SingleWork({ title, desc, link, githublink }) {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 translate-y-full group-hover:translate-y-0 group-hover:bottom-4 transition-all duration-700 text-white flex items-center justify-between w-full px-4">
        <a
          href={githublink}
          target="_blank"
